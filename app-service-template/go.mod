...
require (
	...
	github.com/diegoholiveira/jsonlogic/v3 v3.8.1 // indirect
	github.com/eclipse/paho.mqtt.golang v1.5.0 // indirect
	github.com/edgexfoundry/go-mod-bootstrap/v4 v4.1.0-dev.3 // indirect
	github.com/edgexfoundry/go-mod-configuration/v4 v4.1.0-dev.1 // indirect
	github.com/edgexfoundry/go-mod-messaging/v4 v4.1.0-dev.3 // indirect
