...
func (_m *AppFunctionContext) Publish(data interface{}) error {
	ret := _m.Called(data)
...
func (_m *AppFunctionContext) PublishWithTopic(topic string, data interface{}) error {
...
func NewAppFunctionContext(t interface {
	mock.TestingT
	Cleanup(func())
}) *AppFunctionContext {
