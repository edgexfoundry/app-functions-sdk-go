...
func (_m *ApplicationService) ListenForCustomConfigChanges(configToWatch interfaces.WritableConfig, sectionName string, writableChanged chan bool) error {
	ret := _m.Called(configToWatch, sectionName, writableChanged)

	var r0 error
	if rf, ok := ret.Get(0).(func(interfaces.WritableConfig, string, chan bool) error); ok {
