...
func (_m *ApplicationService) AddCustomRoute(route string, authentication interfaces.Authentication, handler func(http.ResponseWriter, *http.Request), methods ...string) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(string, interfaces.Authentication, func(http.ResponseWriter, *http.Request), ...string) error); ok {
...
// PublishWithTopic provides a mock function with given fields: topic, data
func (_m *ApplicationService) PublishWithTopic(topic string, data interface{}) error {
