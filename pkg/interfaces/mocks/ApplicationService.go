...
// ListenForCustomConfigChanges provides a mock function with given fields: configToWatch, sectionName, writableChanged
func (_m *ApplicationService) ListenForCustomConfigChanges(configToWatch interfaces.WritableConfig, sectionName string, writableChanged chan bool) (context.Context, *sync.WaitGroup, error) {
	ret := _m.Called(configToWatch, sectionName, writableChanged)

	var r0 context.Context
	if rf, ok := ret.Get(0).(func(interfaces.WritableConfig, string, chan bool) context.Context); ok {
		r0 = rf(configToWatch, sectionName, writableChanged)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 *sync.WaitGroup
	if rf, ok := ret.Get(1).(func(interfaces.WritableConfig, string, chan bool) *sync.WaitGroup); ok {
		r1 = rf(configToWatch, sectionName, writableChanged)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*sync.WaitGroup)
		}
	}

	var r2 error
	if rf, ok := ret.Get(2).(func(interfaces.WritableConfig, string, chan bool) error); ok {
		r2 = rf(configToWatch, sectionName, writableChanged)
	} else {
		r2 = ret.Error(2)
	}
