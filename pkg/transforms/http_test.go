...
func TestHTTPPostPutWithSecrets(t *testing.T) {
	...
	mockSP.On("GetSecret", "secretname", "header").Return(map[string]string{"Secret-Header-Name": expectedValue}, nil)
	mockSP.On("GetSecret", "secretname", "bogus").Return(nil, errors.New("FAKE NOT FOUND ERROR"))
	...
	tests := []struct {
		...
		{"unsuccessful POST w/o secret header name", path, "", "header", "secretname", false, "HTTP Header Name required when using secrets", ""},
		{"unsuccessful POST w/o secret path", path, "Secret-Header", "header", "", false, "HTTP Header secretName was provided but no secretName was provided", ""},
		{"unsuccessful POST w/o secret name", path, "Secret-Header", "", "secretname", false, "secretName was specified but no secretName was provided", ""},
		{"successful POST with secrets", path, "Secret-Header-Name", "header", "secretname", true, "", http.MethodPost},
		{"successful POST with secrets and formatted path", formatPath, "Secret-Header-Name", "header", "secretname", true, "", http.MethodPost},
		...
		{"unsuccessful POST with secrets - retrieval fails", path, "Secret-Header", "bogus", "secretname", false, "FAKE NOT FOUND ERROR", ""},
		{"unsuccessful PUT w/o secret header name", path, "", "header", "secretname", false, "HTTP Header Name required when using secrets", ""},
		{"unsuccessful PUT w/o secret path name", path, "Secret-Header", "header", "", false, "HTTP Header secretName was provided but no secretName was provided", ""},
		{"successful PUT with secrets", path, "Secret-Header", "header", "secretname", true, "", http.MethodPut},
		{"successful PUT with secrets and formatted path", formatPath, "Secret-Header", "header", "secretname", true, "", http.MethodPut},
		...
		{"unsuccessful PUT with secrets - retrieval fails", path, "Secret-Header", "bogus", "secretname", false, "FAKE NOT FOUND ERROR", ""},
		{"unsuccessful PUT with secrets - retrieval fails", path, "Secret-Header", "bogus", "secretname", false, "FAKE NOT FOUND ERROR", ""},
	}
